...
function Portfolio() {
    ...
    return (
        ...
        <div class="container md">
            <div class="row mt-5">
            <div class="card crdPrac1 col-sm-6 col-md-7 ">
            ...
            <div class="card card-block crdPrac2 col-5 col-md-4 mt-5 mb-5">
                <img class="card-img-top pic" src={HolderImg} alt="Card image cap"/>
                    <div class="card-body">
                        <h3 class="card-title text-start">Learn more about the process</h3>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            ...
            <div class="row">
                <div class="card crdPrac3 offset-md-8 col-5 col-md-4 mb-5">
                    <img class="card-img-top pic" src={HolderImg} alt="Card image cap"/>
                        <div class="card-body">
                            <h3 class="card-title text-start">Learn more about the process</h3>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
